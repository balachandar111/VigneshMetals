...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    review: 'The Kuthu Vilakku I purchased from Vignesh Super Store is absolutely stunning. The craftsmanship is exceptional and it looks exactly like the pictures. My pooja room feels so much more divine now. Highly recommended!',
  ...
  },
  {
    ...
    rating: 5,
    review: 'Excellent quality brass lamp. The finish is perfect and the weight feels premium. Delivery was prompt and the packaging was very secure. Will definitely order more items from Vignesh Super Store.',
  ...
  },
  {
    ...
    rating: 5,
    review: 'I bought the Navagraha lamp as a housewarming gift and everyone was amazed by its beauty. The intricate detailing and the golden shine of the brass is breathtaking. Thank you Vignesh Super Store!',
  ...
  },
  {
    ...
    rating: 5,
    review: 'Been searching for an authentic South Indian brass lamp for years. Finally found Vignesh Super Store and I am so happy. The quality is outstanding and the price is very reasonable. The lamp lights up beautifully.',
  ...
  },
  {
    ...
    rating: 5,
    review: 'Ordered the Peacock design lamp for Diwali and it was the centerpiece of our celebration. The attention to detail is incredible. Every guest asked where I bought it. Vignesh Super Store is truly the best!',
